...
function navButtonActive(b, e, v) {
    ...
    } else if (fab2Check && 'share' in navigator) {
    ...
    if (target.classList.contains("hoverB") || v || (!v && fab2Close)) {
        ...
        if (b && !v) { // navigate to section
            ...
            const activeSection = fab2Close ? document.querySelector('.pwa .sections .home') : document.querySelector('.pwa .sections .' + activeTab);
