...
var wH = window.outerHeight, // height
    ...
    dev = {
        ...
        version : "2.5", // site version
        version_up : "2.6", // version upgrade (if applicable, during maintenance)
...
function pL() { // site parameters loop
    ...
    if (((!navigator.cookieEnabled && !op.pwa.s && (!navigator.cookieEnabled || !getCookie("testCookie"))) || navigator.cookieEnabled && !getCookie("testCookie")) && op.c.e && !pg.msg.c && !eR.s && rL.i) { // if cookies are disabled
