...
var wH = window.outerHeight, // height
    ...
    dev = {
        ...
        info : { // personal information - CHANGE WHEN NEEDED
            ...
            work: ["i think", "we can", "do better.", "let's do this,", "cheers! :)"], // labels
        ...
        version : "3.14", // site version
        version_up : "3.15", // version upgrade (if applicable, during maintenance)
