...
var wH = window.outerHeight, // height
    ...
    dev = {
        ...
        sC_a : (op.sys !== "iOS" && op.sys !== "Android") ? [20, 80] : [10, 90], // split-screen ratio array (desktop : mobile/tablet/phablet/touch-device)
...
function checkSplitScreen() {
    ...
    if ((((bTop / window.screen.availHeight) * 100) > dev.sC_a[0]) || (((bBottom / window.screen.availHeight) * 100) < dev.sC_a[1])) { // mobile
