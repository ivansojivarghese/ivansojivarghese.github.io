...
window.addEventListener("resize", function(e) {
    op.zoom = !op.b.f ? Math.round((window.outerWidth / window.innerWidth) * dev.z) : Number((Number(getCookie("maxHeight")) / window.innerHeight).toFixed(2)) * dev.z; // FIREFOX follows a different strategy (cookie-based, initial user settings)
    var w = dev.z / dev.z,
