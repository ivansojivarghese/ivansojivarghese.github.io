...
var wH = window.outerHeight, // height
    ...
    dev = {
        ...
        version : "2.1", // site version
        version_up : "2.2", // version upgrade (if applicable, during maintenance)
    ...
    if (rL && rL.i) {
        ...
        if (!op.bNx) { // check if current platform is up-to-date
            ...
            if (op.bInfo.cSts !== "latest" && (!eR.s) && !op.pl && !developer) { // if platform not updated
                ...
                eR.pl_e.h.setAttribute("href", "javascript:void(0)");
