    ...
    */
    ...
    function updateVideoLoad() {
      ...
      if (currentBuffer < MOD_BUFFER_THRESHOLD) {
        ...
        if (video.paused && !autoLoad && (initialVideoLoad || qualityBestChange || qualityChange || ((audio.buffered && backgroundPlay) || video.buffered && audio.buffered && !backgroundPlay && bufferLoad))) { 
          console.log("play");
          // video.play();
          if (backgroundPlay) {
            audio.play();
