...
function formatURLsToGenericLink(text) {
  ...
  return text.replace(urlRegex, (url) => {
    // Wrap the fetch inside a function for asynchronous fetching
    ...
    // Return a placeholder link while metadata is loading
    return `<a href="${url}" target="_blank" class="url trs">${url}</a>`;
  });
}
