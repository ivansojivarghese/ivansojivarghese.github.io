...
const staticCacheName = 'media-player-v2.81';
...
const assets = [
  ...
  'https://ivansojivarghese.github.io/media-player/svg/playlist_play.svg',
  'https://ivansojivarghese.github.io/media-player/svg/radio.svg'
];
