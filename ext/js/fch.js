...
function load_css_e() { // load CSS styles (page specific)
    ...
    c_css(".bg-circles .circle-3", "top: calc(7rem + (" + mg + ") + 15rem);", false, null); // 7rem + profile_image top margin + inward offset (rel. to p. image height)
    c_css(".bg-circles .circle-4", "top: calc(" + aH + "px - 3rem);", false, null); 
